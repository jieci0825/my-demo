...
import { SINGLE_PIC_SELECT_KEY, SINGLE_SELECT_KEY, TEXT_NODE_KEY, PRESET_PERSONAL_INFO_GENDER_KEY } from '@/constants'
import { updateInitStatusBeforeAdd } from '@/utils'
import type { MaterialKeys } from '@/types/materials'

// 需要初始化的业务组件key
const keyToInit: MaterialKeys[] = [PRESET_PERSONAL_INFO_GENDER_KEY]
